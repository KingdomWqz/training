...
### 一、课程导入与AI编程工具格局（4分钟）
1. **破冰：学员使用现状调查**
   - 是否用过 Copilot / Cursor / WorkBuddy / Codex
   - 本次培训最想解决的问题收集
2. **AI 编程工具三次范式变迁**
...
8. **推荐**：主力 CLI + App 覆盖 80% 需求；按痛点逐个解锁其他形态，避免一上来全装

### 三、动手安装与环境配置（10分钟）
1. **前提条件检查**
   - ChatGPT Plus 及以上账号（说明各套餐差异，见官网）
...
2. **关键认知：不同档位模型配合使用**：日常任务用 GPT-5.6 Luna，关键任务才切 GPT-5.6 Sol
3. **/status 查看用量**的习惯培养
